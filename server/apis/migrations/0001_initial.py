    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Admin'), ('STUDENT', 'Student')], default='STUDENT', max_length=20, verbose_name='Role')),
                ('email', models.EmailField(error_messages={'unique': 'A user with that email already exists.'}, max_length=254, unique=True, verbose_name='Email Address')),
                ('avatar', models.ImageField(blank=True, help_text='Upload your profile picture.', null=True, storage=cloudinary_storage.storage.MediaCloudinaryStorage(), upload_to='avatars/%y/%m/%d', verbose_name='Avatar')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(blank=True, default='', help_text='A short label, generally used in URLs.')),
